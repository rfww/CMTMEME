...
class TorchvisionTransforms(BaseProcessor):
    def __init__(self, config, *args, **kwargs):
        ...
        transforms_list = []
        # transforms_list = [transforms.RandomRotation(degrees=(0, 30)),transforms.RandomHorizontalFlip(p=0.3),transforms.RandomVerticalFlip(p=0.3)] 
        # transforms_list = [transforms.RandomHorizontalFlip(p=0.3),transforms.RandomVerticalFlip(p=0.3)] 
